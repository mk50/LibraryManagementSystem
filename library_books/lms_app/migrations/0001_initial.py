# Generated by Django 3.2.9 on 2021-11-25 01:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('availbe', 'availble'), ('rental', 'rental'), ('sold', 'sold')], max_length=50, null=True)),
